...
const iconPaths: Record<string, string> = {
  ...
  calendar: 'M7 2v4M17 2v4M3 9h18M5 4h14a2 2 0 0 1 2 2v13a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2Z', filter: 'M4 5h16M7 12h10M10 19h4', plus: 'M12 5v14M5 12h14', upload: 'M12 16V4m0 0L7 9m5-5 5 5M5 20h14', download: 'M12 4v12m0 0 5-5m-5 5-5-5M5 20h14',
  ...
  headset: 'M4 14v-2a8 8 0 0 1 16 0v2M4 14h3v5H5a1 1 0 0 1-1-1v-4Zm16 0h-3v5h2a1 1 0 0 0 1-1v-4Z', check: 'm5 12 4 4L19 6', alert: 'M12 9v4M12 17h.01M10.3 3.4 2.2 18a2 2 0 0 0 1.7 3h16.2a2 2 0 0 0 1.7-3L13.7 3.4a2 2 0 0 0-3.4 0', info: 'M12 16v-4M12 8h.01M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z', flask: 'M9 3h6M10 3v6l-5.2 8.7A2 2 0 0 0 6.5 21h11a2 2 0 0 0 1.7-3.3L14 9V3M8 15h8', more: 'M5 12h.01M12 12h.01M19 12h.01', bot: 'M12 3v3m-5 3h10M5 9h14v9H5zM8 13h.01M16 13h.01M9 16h6', chart: 'M4 19V5m0 14h16M8 16v-4m4 4V8m4 8v-7', mic: 'M12 14a3 3 0 0 0 3-3V6a3 3 0 0 0-6 0v5a3 3 0 0 0 3 3Zm-7-3a7 7 0 0 0 14 0M12 18v3M8 21h8', 'mic-off': 'm3 3 18 18M10 5.2A3 3 0 0 1 15 7v4M9 9v2a3 3 0 0 0 5.1 2.1M5 11a7 7 0 0 0 11.3 5.5M19 11a7 7 0 0 1-1.1 3.8M12 18v3M8 21h8',
  unlock: 'M8 11V7a4 4 0 0 1 7.6-1.8M5 11h14v10H5z', lock: 'M6 11h12v10H6zM8 11V7a4 4 0 0 1 8 0v4', clock: 'M12 7v5l3 2M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z', activity: 'M3 12h4l2-7 4 14 2-7h6', archive: 'M3 4h18v4H3zM5 8v12h14V8M10 12h4', trash: 'M4 7h16M10 11v6M14 11v6M6 7l1 13h10l1-13M9 7V4h6v3', note: 'M14 3v5h5M6 3h8l5 5v13H6zM9 13h6M9 17h6', 'credit-card': 'M3 6h18v12H3zM3 10h18M7 15h3',
};
