...
async function main() {
  ...
  if (process.env.NODE_ENV !== 'development' && process.env.NODE_ENV !== 'test' && password === 'change-this-password') throw new Error('SUPERADMIN_PASSWORD ainda está com o valor de exemplo; defina uma senha real antes de rodar em produção');
