...
const plans: Plan[] = [
  { code: 'starter', productName: 'ZapLiga Starter', description: 'Para equipes pequenas - ate 2 SDRs', sortOrder: 10, maxSdrs: 2, includedSdrs: 2, monthly: 8990, yearly: 89900, features: { schedule_enforcement: 'full', callbacks: 'full', privacy_requests: 'full', onboarding: 'full', operation_health: 'basic' }, limits: { leads: 25_000, retention_days: 90 } },
  { code: 'growth', productName: 'ZapLiga Growth', description: 'Para operacoes em crescimento - ate 5 SDRs', sortOrder: 20, maxSdrs: 5, includedSdrs: 5, monthly: 24_990, yearly: 249_900, features: { schedule_enforcement: 'full', callbacks: 'full', privacy_requests: 'full', onboarding: 'full', campaigns: 'full', decision_engine: 'full', recommendations: 'full', operation_health: 'full', lead_ingestion_api: 'full', advanced_reports: 'basic' }, limits: { leads: 250_000, retention_days: 365 } },
  { code: 'pro', productName: 'ZapLiga Pro', description: 'Para operacoes avancadas - ate 10 SDRs', sortOrder: 30, maxSdrs: 10, includedSdrs: 10, monthly: 59_990, yearly: 599_900, features: { schedule_enforcement: 'full', callbacks: 'full', privacy_requests: 'full', onboarding: 'full', campaigns: 'full', decision_engine: 'full', recommendations: 'full', operation_health: 'full', analytics_learning: 'full', experiments: 'full', benchmarks: 'full', lead_ingestion_api: 'full', advanced_reports: 'full' }, limits: { leads: 1_000_000, retention_days: 730 } },
];
