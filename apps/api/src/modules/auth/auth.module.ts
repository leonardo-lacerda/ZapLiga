...
@Global()
@Module({
  imports: [JwtModule.register({ secret: process.env.JWT_ACCESS_SECRET ?? 'dev-only-change-this-secret' }), RedisModule, BillingModule, forwardRef(() => UsersModule), forwardRef(() => AuditModule)],
