...
// Three URL shapes share this upgrade handler: the tenant-scoped control
// channel, the tenant-scoped media channel, and the legacy (pre-multi-tenant)
// media channel that still routes SDRs that predate scoped URLs.
